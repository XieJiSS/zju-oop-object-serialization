...
int main() {
  ...
  serialize_xml(u_char1, "u_char", "result/u_char.xml");
  serialize_xml(s_char1, "s_char", "result/s_char.xml");
  serialize_xml(u_short1, "u_short", "result/u_short.xml");
  serialize_xml(s_short1, "s_short", "result/s_short.xml");
  serialize_xml(u_int1, "u_int", "result/u_int.xml");
  serialize_xml(s_int1, "s_int", "result/s_int.xml");
  serialize_xml(u_longlong1, "u_longlong", "result/u_longlong.xml");
  serialize_xml(s_longlong1, "s_longlong", "result/s_longlong.xml");
  serialize_xml(float1, "float", "result/float.xml");
  serialize_xml(double1, "double", "result/double.xml");
  serialize_xml(long_double1, "long_double", "result/long_double.xml");
  deserialize_xml(u_char2, "u_char", "result/u_char.xml");
  deserialize_xml(s_char2, "s_char", "result/s_char.xml");
  deserialize_xml(u_short2, "u_short", "result/u_short.xml");
  deserialize_xml(s_short2, "s_short", "result/s_short.xml");
  deserialize_xml(u_int2, "u_int", "result/u_int.xml");
  deserialize_xml(s_int2, "s_int", "result/s_int.xml");
  deserialize_xml(u_longlong2, "u_longlong", "result/u_longlong.xml");
  deserialize_xml(s_longlong2, "s_longlong", "result/s_longlong.xml");
  deserialize_xml(float2, "float", "result/float.xml");
  deserialize_xml(double2, "double", "result/double.xml");
  deserialize_xml(long_double2, "long_double", "result/long_double.xml");
  ...
  serialize_xml(str1, "str", "result/str.xml");
  deserialize_xml(str2, "str", "result/str.xml");
  EXPECT_EQ(str1, str2, "string");

  // test vector
  vector<int> vec1 = {1, 2, 3, 4, 5};
  serialize_xml(vec1, "std_vector", "result/vector.xml");
  vector<int> vec2;
  deserialize_xml(vec2, "std_vector", "result/vector.xml");
  ...
  serialize_xml(list1, "std_list", "result/list.xml");
  list<int> list2;
  deserialize_xml(list2, "std_list", "result/list.xml");
  ...
  serialize_xml(map1, "std_map", "result/map.xml");
  map<int, int> map2;
  deserialize_xml(map2, "std_map", "result/map.xml");
  ...
  // test set
  set<int> set1 = {1, 2, 1};
  serialize_xml(set1, "std_set", "result/set.xml");
  set<int> set2;
  deserialize_xml(set2, "std_set", "result/set.xml");
  ...
  serialize_xml(unordered_map1, "std_unordered_map", "result/unordered_map.xml");
  unordered_map<int, int> unordered_map2;
  deserialize_xml(unordered_map2, "std_unordered_map", "result/unordered_map.xml");
  ...
  serialize_xml(pair1, "std_pair", "result/pair.xml");
  pair<int, int> pair2;
  deserialize_xml(pair2, "std_pair", "result/pair.xml");
  ...
  serialize_xml(tuple1, "std_tuple", "result/tuple.xml");
  tuple<int, int, int> tuple2;
  deserialize_xml(tuple2, "std_tuple", "result/tuple.xml");
  ...
  serialize_xml(udt1, "udt", "result/udt.xml");
  UserDefinedType udt2;
  deserialize_xml(udt2, "udt", "result/udt.xml");
  ...
  try {
    deserialize_xml(udt1, "udt", "result/non_existing_file.xml");
    EXPECT_EQ(1, 0, "deserialize from non-existing file should throw an exception");
  } catch (const std::exception& e) {
    cout << "PASSED (XFAIL) deserialize_xml(udt1, \"result/non_existing_file.xml\") failed as expected." << endl;
  }

  // test consts
  // const arithmetic
  const int const_int1 = 1;
  serialize_xml(const_int1, "const_int", "result/const_int.xml");
  int const_int2;
  deserialize_xml(const_int2, "const_int", "result/const_int.xml");
  EXPECT_EQ(const_int1, const_int2, "const int");

  // const string
  const string const_str1 = "MyName";
  serialize_xml(const_str1, "const_str", "result/const_str.xml");
  string const_str2;
  deserialize_xml(const_str2, "const_str", "result/const_str.xml");
  EXPECT_EQ(const_str1, const_str2, "const string");

  // const pair (test trivial container)
  const pair<int, int> const_pair1 = {1, 2};
  serialize_xml(const_pair1, "const_std_pair", "result/const_pair.xml");
  pair<int, int> const_pair2;
  deserialize_xml(const_pair2, "const_std_pair", "result/const_pair.xml");
  ...
  serialize_xml(const_tuple1, "const_std_tuple", "result/const_tuple.xml");
  tuple<int, int, int> const_tuple2;
  deserialize_xml(const_tuple2, "const_std_tuple", "result/const_tuple.xml");
  ...
  serialize_xml(const_vector1, "const_std_vector", "result/const_vector.xml");
  vector<int> const_vector2;
  deserialize_xml(const_vector2, "const_std_vector", "result/const_vector.xml");
