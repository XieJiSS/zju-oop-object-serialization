...
int main() {
  ...
  serialize(u_char1, "result/u_char.bin");
  serialize(s_char1, "result/s_char.bin");
  serialize(u_short1, "result/u_short.bin");
  serialize(s_short1, "result/s_short.bin");
  serialize(u_int1, "result/u_int.bin");
  serialize(s_int1, "result/s_int.bin");
  serialize(u_longlong1, "result/u_longlong.bin");
  serialize(s_longlong1, "result/s_longlong.bin");
  serialize(float1, "result/float.bin");
  serialize(double1, "result/double.bin");
  serialize(long_double1, "result/long_double.bin");
  deserialize(u_char2, "result/u_char.bin");
  deserialize(s_char2, "result/s_char.bin");
  deserialize(u_short2, "result/u_short.bin");
  deserialize(s_short2, "result/s_short.bin");
  deserialize(u_int2, "result/u_int.bin");
  deserialize(s_int2, "result/s_int.bin");
  deserialize(u_longlong2, "result/u_longlong.bin");
  deserialize(s_longlong2, "result/s_longlong.bin");
